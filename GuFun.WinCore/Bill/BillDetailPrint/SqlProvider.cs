...
namespace GuFun.WinCore
{
  ...
  {
    public static BillDetail PopulateBillDetailPrint(IDataReader reader)
    {
    ...
    public static BillDetail GetBillDetailPrint(int billno)
    {
      BillDetail item = new BillDetail();
      ...
      try
      {
        ...
        SqlDataReader reader = DBUtils.ExecuteReader(CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_Get_BillDetailPrint", paras);
    ...
    public static void CreateUpdateDeleteBillDetailPrint(BillDetail item, DataProviderAction action)
    {
      if (item == null)
        return;
      ...
      try
      {
        ...
        DBUtils.ExecuteNonQuery(conn, cmd, CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_CreateUpdateDelete_BillDetailPrint", paras);
    ...
    public static BillFormat GetPrintInfoByBankPrint(short bank, short type, bool ishalf, int billno)
    {
      ...
      try
      {
        ...
        SqlDataReader reader = DBUtils.ExecuteReader(CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_Get_PrintInfoByBankPrint", paras);
    ...
    public static void ModifyPrintDatePrint(BillDetail item)
    {
      if (item == null)
        return;
      ...
      try
      {
        ...
        DBUtils.ExecuteNonQuery(conn, cmd, CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_Modify_PrintDatePrint", paras);
    ...
    public static void PrintBillDetailPrint(int billno, short status, string manid)
    {
      SqlConnection conn = DBUtils.GetConnection();
      SqlCommand cmd = DBUtils.GetCommand();
      ...
      try
      {
        ...
        DBUtils.ExecuteNonQuery(conn, cmd, CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_Print_BillDetailByStatusPrint", paras);
    ...
    public static void PrintBillDetailPrint(int billno)
    {
      SqlConnection conn = DBUtils.GetConnection();
      SqlCommand cmd = DBUtils.GetCommand();
      ...
      try
      {
        ...
        DBUtils.ExecuteNonQuery(conn, cmd, CommandType.StoredProcedure, PublicConsts.DatabaseOwner + ".P_Print_BillDetailPrint", paras);
