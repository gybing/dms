...
namespace GuFun.WinControls
{
    ...
    public class Office2007ColorTable : ProfessionalColorTable
    {
        ...
        private static Color _menuToolBack = Color.FromArgb(131, 209, 196);
      ...
      private static Color _statusStripLight = Color.FromArgb(185, 227, 220);
      private static Color _statusStripDark = Color.FromArgb(81, 182, 165);
        ...
        private static Color _toolStripBegin = Color.FromArgb(185, 227, 220);
        private static Color _toolStripEnd = Color.FromArgb(81, 182, 165);
        private static Color _toolStripMiddle = Color.FromArgb(131, 209, 196);
