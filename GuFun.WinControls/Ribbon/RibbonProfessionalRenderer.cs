...
namespace GuFun.WinControls
{
        ...
        : RibbonRenderer
  {
    ...
    public void DrawCaptionBarBackground(Rectangle r, Graphics g)
    {
      ...
      Rectangle r1 = new Rectangle(0, 0, r.Width, 4);
      Rectangle r2 = new Rectangle(0, r1.Bottom, r.Width, 4);
      Rectangle r3 = new Rectangle(0, r2.Bottom, r.Width, r.Height - 8);
      Rectangle r4 = new Rectangle(0, r3.Bottom, r.Width, 1);
