...
namespace GuFun.WinControls
{
  public class RibbonProfesionalRendererColorTable
  {
    ...
    public Color RibbonBackground = FromHex("#83D1C4");
    public Color TabBorder = FromHex("#8DB2E3");
    //public Color TabNorth = FromHex("#B9E3DC");
    //public Color TabSouth = FromHex("#51B6A5");
    //public Color TabGlow = FromHex("#83D1C4");
    ...
    public Color TabContentNorth = FromHex("#B9E3DC");
    public Color TabContentSouth = FromHex("#62BEAF");
    //public Color TabSelectedGlow = FromHex("#83D1C4");
    ...
    public Color PanelTextBackground = FromHex("#83D1C4");
    public Color PanelTextBackgroundSelected = FromHex("#AEE2D9");
    ...
    protected static Color ToGray(Color c)
    {
      int m = (c.R + c.G + c.B) / 3;
